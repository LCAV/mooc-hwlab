...
_Note: keep in mind the points made about using_ `float` _or_ `int` _variables \(see_ [_here_](../../real-world-dsp/dsp_tips.md#float)_\)._
{% endhint %}
